...
<form name="boardForm" method="post">
  ...
  <tr height="40" style="border-bottom: 1px solid #cccccc;">
      <td width="100" bgcolor="#eeeeee" align="center">패스워드</td> <%--패스워드에는 value속성주는거 아니다. --%>
      <td style="padding-left:10px;"> 
  ...
  <tr height="45"> 
      <td align="center" colspan="2">
        ...
        <button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/bbs/list.jsp';">수정취소</button>
      </td>
  </tr>
  </table>
</form>
