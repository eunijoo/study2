...
<%
	...
	int pay=total_pay-tax; //총금액-세금= 실제 pay

	NumberFormat nf = NumberFormat.getCurrencyInstance();  //원화기호나오는게하는거
	
	Calendar cal=Calendar.getInstance(); //생일객체
...
<div style="width: 400px; margin:30px auto;">
	...
	<table border="1" style="width: 100%; border-spacing: 0; border-collapse: collapse;">
		...
		<tr height="25">
		   ...
		   <td width="300" style="padding-left: 10px">
		         <%=nf.format(salary)%> <%--nf.format사용해야 원화기호가 나온다. --%>
		   </td>
		</tr>
		<tr height="25">
